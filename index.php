...
<form action="" method="POST" id="payment-form" class="form-horizontal">
    ...
    if ($_POST) {
        ...
        try {
            ...
            $qan = strpos($_POST['quantity'],'.') === false ? $_POST['quantity'] . '00' :
                str_replace('.', '', $_POST['quantity']);
            Stripe_Charge::create(array("amount" => $qan,
                "currency" => "eur",
    ...
    <div class="container">
        ...
        <fieldset class="m6 s12">
            ...
            <!-- Stripe Logo -->
            <div class="form-group">
                <img style="position:relative;left:100px;width:300px" src="img/StripePowered.png">
            </div>
        </fieldset>
